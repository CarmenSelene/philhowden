        ...
        return (
            <div className="resumeblock">
                ...
                <Animate
                    ...
                    duration={500}
                    transitionOnMount
                    stayMounted={this.state.certShow}
                    style={{
                        width: "auto",
                        height: "100%",
                        display: "flex",
                ...
                <strong className="resumeTitle" onClick={() => { this.toggleShow("vtrShow") }}><i className="fas fa-plus addpadd"></i> VTR Assistant</strong>
                <Animate
                    show={this.state.vtrShow}
                    duration={500}
                    transitionOnMount
                    stayMounted={this.state.vtrShow}
                    style={{
                        width: "auto",
                        height: "100%",
                        display: "flex",
                ...
                <strong className="resumeTitle" onClick={() => { this.toggleShow("gafferShow") }}><i className="fas fa-plus addpadd"></i> Gaffer Work Experience</strong>
                <Animate
                    show={this.state.gafferShow}
                    duration={500}
                    transitionOnMount
                    stayMounted={this.state.gafferShow}
                    style={{
                        width: "auto",
                        height: "100%",
                        display: "flex",
                ...
                <strong className="resumeTitle" onClick={() => { this.toggleShow("dailyElShow") }}><i className="fas fa-plus addpadd"></i> Daily Electric Experience</strong>
                <Animate
                    show={this.state.dailyElShow}
                    duration={500}
                    transitionOnMount
                    stayMounted={this.state.dailyElShow}
                    style={{
                        width: "auto",
                        height: "100%",
                        display: "flex",
                ...
                <strong className="resumeTitle" onClick={() => { this.toggleShow("dailyGripShow") }}><i className="fas fa-plus addpadd"></i> Daily Grip Experience</strong>
                <Animate
                    show={this.state.dailyGripShow}
                    duration={500}
                    transitionOnMount
                    stayMounted={this.state.dailyGripShow}
                    style={{
                        width: "auto",
                        height: "100%",
                        display: "flex",
                ...
                <strong className="resumeTitle" onClick={() => { this.toggleShow("paShow") }}><i className="fas fa-plus addpadd"></i> Production Assistant Work Experience</strong>
                <Animate
                    show={this.state.paShow}
                    duration={500}
                    transitionOnMount
                    stayMounted={this.state.paShow}
                    style={{
                        width: "auto",
                        height: "100%",
                        display: "flex",
                ...
                {/* References */}
                <strong className="resumeTitle" onClick={() => { this.toggleShow("references") }}><i className="fas fa-plus addpadd"></i> References</strong>
                <Animate
                    show={this.state.references}
                    duration={500}
                    transitionOnMount
                    stayMounted={this.state.references}
                    style={{
                        width: "auto",
                        height: "100%",
                        display: "flex",
